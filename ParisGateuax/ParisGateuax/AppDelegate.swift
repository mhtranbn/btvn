...
class AppDelegate:  UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication!, didFinishLaunchingWithOptions launchOptions: NSDictionary!) -> Bool {
        ...
        var vc1 = MenuVC(nibName: "MenuVC", bundle: nil)
        var vc1a = UINavigationController(rootViewController:vc1)
        var vc2 = ContactVC(nibName: "ContactVC", bundle: nil)
        var vc2a = UINavigationController(rootViewController:vc2)
        var vc3 = ShopVC(nibName: "ShopVC", bundle: nil)
        var vc3a = UINavigationController(rootViewController:vc3)
        var vc4 = AboutVC(nibName: "AboutVC", bundle: nil)
