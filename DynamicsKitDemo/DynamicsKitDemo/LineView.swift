...
class LineView: UIView {
    ...
    func drawMagnitudeVectorWithLength(length:CGFloat, angle:CGFloat, color:UIColor, temporaru:Bool){
        if(self.arrowView == nil) {
            var arrowImage = UIImage(named:"Arrow")!.imageWithRenderingMode(UIImageRenderingMode.AlwaysTemplate)
            var arrowImageView = UIImageView(image: arrowImage)
