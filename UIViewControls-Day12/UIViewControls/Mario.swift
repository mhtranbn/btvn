...
class Mario: UIViewController {
    ...
    override func loadView() {
        ...
        box = UIImageView(frame: CGRect(x: 0, y:Double(city1!.frame.origin.y * 2 + 250), width: 30, height: 30))
        box!.image = UIImage(named: "box.jpg")
        self.view.addSubview(box!)
        
        box1 = UIImageView(frame: CGRect(x: 0, y:Double(city1!.frame.origin.y * 2 + 250), width: 80, height: 80))
    ...
    func runCity() {
       ...
       /* city2!.center = CGPoint(x: city2!.center.x - CGFloat(moveX), y: city2!.center.y)
        ...
        box!.frame = CGRect(x: Double(city4!.frame.origin.x) + cityWidth , y: Double(city1!.frame.origin.y * 2 + 250) , width: 30 , height: 30)
        box!.frame = CGRect(x: Double(city4!.frame.origin.x + 50) + cityWidth , y: Double(city1!.frame.origin.y * 2 + 250) , width: 30 , height: 30)
        box1!.frame = CGRect(x: Double(city4!.frame.origin.x + 30) + cityWidth , y: Double(city1!.frame.origin.y * 2 + 250) , width: 50 , height: 50)
        ...
        box!.frame = CGRect(x: Double(city4!.frame.origin.x - 20) + cityWidth , y: Double(city1!.frame.origin.y * 2 + 250) , width: 30 , height: 30)
        box1!.frame = CGRect(x: Double(city4!.frame.origin.x - 50) + cityWidth , y: Double(city1!.frame.origin.y * 2 + 250) , width: 50 , height: 50)
    }
